        ...
        <div className="flex flex-col h-screen bg-gray-100">
            ...
            <main className="flex-1 gap-1 overflow-auto p-4 bg-white flex justify-center">
                ...
                <div className="flex flex-col space-y-4 w-1/2">
                    <video autoPlay  ref={localVideoRef} className="overflow-hidden shadow-lg w-full mx-auto p-4 h-full border-2 border-gray-300 rounded-md bg-black"></video>
                    {lobby ? "Waiting to connect you to someone" : null}
                    <video autoPlay  ref={remoteVideoRef} className="overflow-hidden shadow-lg w-full mx-auto p-4 h-full border-2 border-gray-300 rounded-md bg-black"></video>
                </div>
                {/* Chat Box */}
